...
internal static class Cache
{
    ...
    public static async System.Threading.Tasks.Task RebuildCacheForGuild(ulong guildId)
    {
        ...
        {
            var episodes = allEpisodes.Where(e => e.ProjectId == project.Id)
                .OrderBy(e => e.Number, StringComparison.OrdinalIgnoreCase.WithNaturalSort()).ToList();
    ...
    {
        return ObserverCache.TryGetValue(guildId, out var cachedObservers) ? cachedObservers : [];
    }
