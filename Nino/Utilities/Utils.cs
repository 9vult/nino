...
namespace Nino.Utilities
{
    internal static class Utils
    {
        ...
        public static bool VerifyAdministrator(DataContext db, SocketGuildUser member, SocketGuild guild, bool excludeServerAdmins = false)
        {
            // Admin role
        ...
        public static async Task AlertError(Exception exception, SocketGuild guild, string nickname, ulong ownerId, string location)
        {
        ...
        /// <param name="location">Where the error occured</param>
        /// <returns>void</returns>
        public static async Task AlertError(string error, SocketGuild guild, string nickname, ulong ownerId, string location)
