...
{
    [SlashCommand("import", "Import template staff in jsonl format")]
    ...
    )
    {
        ...
        var query = new ImportTemplateStaffCommand(projectId, fileContent, requestedBy);
        ...
        var addedCount = result.Value.Item1.AddedStaffCount;
        ...
        var successEmbed = new EmbedBuilder()
            ...
            .WithDescription(T("templateStaff.import.success", locale, args));
