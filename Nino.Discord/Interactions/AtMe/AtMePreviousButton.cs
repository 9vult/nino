...
public sealed class AtMePreviousButton(
...
{
    [ComponentInteraction("nino.atMe.prev:*", ignoreGroupNames: true)]
    public async Task<RuntimeResult> GoToPreviousPageAsync(string rawId)
    {
