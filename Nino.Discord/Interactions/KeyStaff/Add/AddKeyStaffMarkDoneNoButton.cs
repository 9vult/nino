...
public partial class KeyStaffModule
{
    ...
    public async Task<RuntimeResult> CreateAndDoNotMarkDoneAsync(string rawId)
    {
        ...
        // Make the request
        var result = await addHandler.HandleAsync(command with { MarkDoneForDoneEpisodes = false });
