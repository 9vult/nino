...
public partial class EpisodesModule
{
    ...
    )
    {
        ...
        var commandDto = new AddEpisodeCommand(projectId, episodeNumber, quantity, requestedBy);
        ...
        if (result.Status != ResultStatus.Success)
        {
            return await interaction.FailAsync(
                result.Status switch
                {
                    ...
                    ResultStatus.BadRequest => T("episode.creation.badRequest", locale),
        ...
        var embed = new EmbedBuilder()
            ...
            .WithDescription(T("episode.creation.success", locale, dict))
            .Build();
