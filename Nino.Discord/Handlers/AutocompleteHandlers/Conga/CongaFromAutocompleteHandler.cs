...
using Nino.Core.Features.Queries.Projects.Conga.ListFromNodeOptions;
...
public sealed class CongaFromAutocompleteHandler : AutocompleteHandler
{
    /// <inheritdoc />
    ...
    )
    {
        ...
        var handler = scope.ServiceProvider.GetRequiredService<ListCongaFromNodeOptionsHandler>();
        ...
        var result = await projectResolver
            ...
            .BindAsync(projectId =>
                handler.HandleAsync(new ListCongaFromNodeOptionsQuery(projectId))
            );
