...
using Nino.Core.Features.Queries.Projects.Conga.ListToNodeOptions;
...
public sealed class CongaToAutocompleteHandler : AutocompleteHandler
{
    /// <inheritdoc />
    ...
    )
    {
        ...
        var handler = scope.ServiceProvider.GetRequiredService<ListCongaToNodeOptionsHandler>();
        ...
        var result = await projectResolver
            ...
            .BindAsync(projectId =>
                handler.HandleAsync(new ListCongaToNodeOptionsQuery(projectId))
            );
