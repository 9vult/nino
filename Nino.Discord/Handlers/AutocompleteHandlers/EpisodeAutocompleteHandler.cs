...
using Nino.Core.Features.Queries.Episodes.List;
...
public sealed class EpisodeAutocompleteHandler : AutocompleteHandler
{
    /// <inheritdoc />
    ...
    )
    {
        ...
        var handler = scope.ServiceProvider.GetRequiredService<ListEpisodesHandler>();
        ...
        var result = await projectResolver
            ...
            .BindAsync(projectId => handler.HandleAsync(new ListEpisodesQuery(projectId)));
