    ...
    >
{
    ...
    )
    {
        ...
        var episodes = observer.Project.Episodes.OrderByNumber().ToList();
        ...
        return Success(
            new GetBulkObserverUpdateNotificationDataResponse(
                ...
                observer.OriginGroup.Name,
                observer.Group.Configuration.IncludeGroupNameInObserverProgress,
