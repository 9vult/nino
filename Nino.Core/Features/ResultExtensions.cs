...
public static class ResultExtensions
{
    ...
    /// <summary>
    /// Awaits <paramref name="resultTask"/> and, if successful, passes the accumulated tuple to
    /// <paramref name="next"/>, extending it with the newly produced value.
    /// Short-circuits on failure at either step.
    /// </summary>
    ...
    /// <param name="next">
    /// The async operation to invoke with the full <c>(<typeparamref name="T1"/>, <typeparamref name="T2"/>)</c>
    /// tuple, allowing any prior value to be used.
    /// </param>
    /// <returns>
    ...
    /// <param name="next">
    /// The async operation to invoke with the full <c>(<typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>)</c>
    /// tuple, allowing any prior value to be used.
    /// </param>
    /// <returns>
