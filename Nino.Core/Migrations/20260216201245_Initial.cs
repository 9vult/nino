        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirReminderRoleId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_MentionRoles_AirReminderRoleId",
                        column: x => x.AirReminderRoleId,
                        principalTable: "MentionRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Projects_Users_AirReminderUserId",
                        column: x => x.AirReminderUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_AirReminderRoleId",
                table: "Projects",
                column: "AirReminderRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_AirReminderUserId",
                table: "Projects",
                column: "AirReminderUserId");
