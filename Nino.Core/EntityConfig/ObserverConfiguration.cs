...
public sealed class ObserverConfiguration : IEntityTypeConfiguration<Observer>
{
    ...
    public void Configure(EntityTypeBuilder<Observer> observer)
    {
        ...
        observer
            .HasOne(e => e.UpdateChannel)
            .WithMany()
            .HasForeignKey(e => e.UpdateChannelId)
            .OnDelete(DeleteBehavior.Restrict);

        observer
            .HasOne(e => e.ReleaseChannel)
            .WithMany()
            .HasForeignKey(e => e.ReleaseChannelId)
            .OnDelete(DeleteBehavior.Restrict);

        observer
            .HasOne(e => e.PrimaryRole)
            .WithMany()
            .HasForeignKey(e => e.PrimaryRoleId)
            .OnDelete(DeleteBehavior.Restrict);

        observer
            .HasOne(e => e.SecondaryRole)
            .WithMany()
            .HasForeignKey(e => e.SecondaryRoleId)
            .OnDelete(DeleteBehavior.Restrict);

        observer
            .HasOne(e => e.TertiaryRole)
            .WithMany()
            .HasForeignKey(e => e.TertiaryRoleId)
            .OnDelete(DeleteBehavior.Restrict);
    }
}
